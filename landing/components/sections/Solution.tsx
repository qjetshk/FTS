...
const SOLUTION = [
  ...
  { n: "02", title: "Никакой 1С — всё в браузере", body: "Не нужно ставить и держать программу учёта. Открыл сайт, нажал — форма готова. Работает на УСН, НПД и любой другой системе налогообложения.", illo: "browser" },
  { n: "03", title: "Подключил Ozon — данные сами в форме", body: "Один раз вводишь Client ID и API-ключ Ozon. Дальше отгрузки, артикулы и страны подтягиваются автоматически — без выгрузок и копирования.", illo: "connect" },
    ...
    <section style={{ background: "var(--background)", padding: "96px 0" }}>
      <div className="container-page" style={{ textAlign: "center" }}>
        ...
        <h2 style={{ margin: "0 0 48px", font: "700 44px/1.1 var(--font-sans)", letterSpacing: "-0.025em", color: "var(--text-primary)" }}>
          Статформа Озон — без ручной работы
        </h2>
      </div>
