...
const PAIN = [
  ...
  { n: "02", title: "1С — не вариант для большинства", body: "Расширения для 1С закрывают задачу, только если весь учёт уже в 1С. Мелкие и средние селлеры на Ozon в ней не сидят — держать 1С ради одной формы в месяц бессмысленно.", illo: "one-c" },
  { n: "03", title: "Каждый месяц — руки в таблицах вместо продаж", body: "Выгружаешь отчёты, копируешь артикулы, сверяешь страны вручную. Ошибся или пропустил строку — начинай заново.", illo: "transfer" },
